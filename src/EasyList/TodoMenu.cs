            ...
            while(true)
            {
                ...
                switch (action)
                {
                    ...
                    case TODOMENU.Delete:
                        var inputDelete = Prompt.Input<IEnumerable<int>>("Enter TODO ID(s) ");
                        
                        var validDeleteList = Validate.MultipleIds(inputDelete);
                    ...
                    case TODOMENU.MarkAsDone:
                        var inputDone = Prompt.Input<IEnumerable<int>>("Enter TODO ID(s) ");

                        var validTodoList = Validate.MultipleIds(inputDone);
